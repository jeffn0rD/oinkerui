...
## Task Information
- **Task ID**: 0.2.5.4
- **Task Name**: API & Interaction Detail
- **Task Goal**: Expand apis.yaml and ui.yaml with complete endpoint specifications and interaction flows.
...
- **Documentation**: Create task summary in log/task_0.2.5.4_summary.yaml
...
### File Organization
- Task summaries: `log/task_0.2.5.4_summary.yaml`
- Task notes: `log/task_0.2.5.4_notes.yaml` (if needed)
- Verification scripts: `verify/task_0.2.5.4_*.py`
...
python3 tools/doc_query.py --query &quot;0.2.5.4&quot; --mode task --pretty

# Get related specification files
python3 tools/doc_query.py --query &quot;spec/apis.yaml&quot; --mode file --pretty
python3 tools/doc_query.py --query &quot;spec/ui.yaml&quot; --mode file --pretty
python3 tools/doc_query.py --query &quot;docs/diagrams/interaction_flow.mmd&quot; --mode file --pretty
python3 tools/doc_query.py --query &quot;docs/diagrams/api_flow.mmd&quot; --mode file --pretty
...
1. **Create agent prompts** in `prompts/agents/task_0.2.5.4/`
...
1. Run task cleanup tool:
   ```bash
   python3 tools/task_cleanup.py --task-id 0.2.5.4
   ```
