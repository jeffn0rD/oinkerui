...
## Task Information
- **Task ID**: 0.8
- **Task Name**: Create Testing Infrastructure
- **Task Goal**: Set up testing infrastructure for frontend (Vitest), Node.js backend (Jest), and Python backend (pytest).
...
- **Documentation**: Create task summary in log/task_0.8_summary.yaml
...
### File Organization
- Task summaries: `log/task_0.8_summary.yaml`
- Task notes: `log/task_0.8_notes.yaml` (if needed)
- Verification scripts: `verify/task_0.8_*.py`
...
python3 tools/doc_query.py --query &quot;0.8&quot; --mode task --pretty

# Get related specification files
python3 tools/doc_query.py --query &quot;prompts/dev/prompt_0_8_updated.md&quot; --mode file --pretty
...
1. **Create agent prompts** in `prompts/agents/task_0.8/`
...
1. Run task cleanup tool:
   ```bash
   python3 tools/task_cleanup.py --task-id 0.8
   ```
