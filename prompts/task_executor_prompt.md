...
1. `./tools/task_executor.py -t 1.3.0`
2. `./tools/task_executor.py -t 1.4.0`
3. `./tools/task_executor.py -t 1.5.0`
4. `./tools/task_executor.py -t 1.6.0`
5. `./tools/task_executor.py -t 1.7.0`
6. `./tools/task_executor.py -t 1.8.0`
7. `./tools/task_executor.py -t 1.9.0`
